...
import os.path
import sys
from .console import nxc_console
...
class NXCAdapter(logging.LoggerAdapter):
    ...
    @staticmethod
    def init_log_file():
        newpath = SSHMAP_PATH + "/logs/" + datetime.now().strftime("%Y-%m-%d")
...
# initialize the logger for all of sshmap - this is imported everywhere
sshmap_logger = NXCAdapter()